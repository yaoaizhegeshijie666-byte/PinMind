...
function applyReadState(){
  ...
  if(read){list.hidden=true;document.querySelector('.intro').hidden=window.viewingToday===false;document.querySelector('.intro').classList.remove('fade');document.querySelector('#emptyState').hidden=false;}
